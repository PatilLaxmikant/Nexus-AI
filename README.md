...
This platform provides the AI agent with direct access to your file system and terminal.
-   **Use with caution**: Only run this locally or in a sandboxed environment.
-   **Review Code**: Always review code generated by the agent before saving.
